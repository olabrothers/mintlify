...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/getting-started/supporting-os-light@2x.png" alt="supporting-os" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/getting-started/supporting-os-dark@2x.png" alt="supporting-os" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/getting-started/activation-light@2x.png" alt="activation" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/getting-started/activation-dark@2x.png" alt="activation" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/getting-started/unlink-light@2x.png" alt="unlink" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/getting-started/unlink-dark@2x.png" alt="unlink" />
