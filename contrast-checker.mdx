...
<Tip>
	<b>Example:</b> A score of 19.21 is considered excellent and meets AAA
	standards.
</Tip>
...
<img
	...
	src="/_images/pages/contrast-checker/contrast-checker-menu-light@2x.png"
	alt="contrast-checker-menu"
/>
<img
	className="hidden dark:block rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-menu-dark@2x.png"
	alt="contrast-checker-menu"
/>
...
<img
	className="block dark:hidden rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-main-light@2x.png"
	alt="contrast-checker-main"
/>
<img
	className="hidden dark:block rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-main-dark@2x.png"
	alt="contrast-checker-main"
/>
...
<img
	className="block dark:hidden rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-light@2x.png"
	alt="contrast-checker"
/>
<img
	className="hidden dark:block rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-dark@2x.png"
	alt="contrast-checker"
/>
...
<img
	className="block dark:hidden rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-fix-light@2x.png"
	alt="contrast-checker-fix"
/>
<img
	className="hidden dark:block rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-fix-dark@2x.png"
	alt="contrast-checker-fix"
/>
...
<img
	className="block dark:hidden rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-edit-light@2x.png"
	alt="contrast-checker-edit"
/>
<img
	className="hidden dark:block rounded-lg"
	src="/_images/pages/contrast-checker/contrast-checker-edit-dark@2x.png"
	alt="contrast-checker-edit"
/>
...
<Tip>
	<b>Example:</b> Pair dark text with light backgrounds and vice versa to
	maximize contrast.
</Tip>
