...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/url-schemes/license-light@2x.png" alt="license" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/url-schemes/license-dark@2x.png" alt="license" />
...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/url-schemes/picker-light@2x.png" alt="picker" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/url-schemes/picker-dark@2x.png" alt="picker" />
...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/url-schemes/contrast-checker-light@2x.png" alt="contrast-checker" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/url-schemes/contrast-checker-dark@2x.png" alt="contrast-checker" />
...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/url-schemes/preferences-light@2x.png" alt="preferences" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/url-schemes/preferences-dark@2x.png" alt="preferences" />
...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/url-schemes/color-light@2x.png" alt="color" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/url-schemes/color-dark@2x.png" alt="color" />
...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/url-schemes/palette-light@2x.png" alt="palette" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/url-schemes/palette-dark@2x.png" alt="palette" />
