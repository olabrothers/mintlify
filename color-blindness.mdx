...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/color-blindness/color-blindness-menu-light@2x.png" alt="color-blindness-menu" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/color-blindness/color-blindness-menu-dark@2x.png" alt="color-blindness-menu" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/color-blindness/color-blindness-main-light@2x.png" alt="color-blindness-main" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/color-blindness/color-blindness-main-dark@2x.png" alt="color-blindness-main" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/color-blindness/color-blindness-picker-light@2x.png" alt="color-blindness-picker" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/color-blindness/color-blindness-picker-dark@2x.png" alt="color-blindness-picker" />
