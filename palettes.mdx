...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/palettes/main-add-palette-light@2x.png" alt="main-add-palette" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/palettes/main-add-palette-dark@2x.png" alt="main-add-palette" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/palettes/menu-add-palette-light@2x.png" alt="menu-add-palette" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/palettes/menu-add-palette-dark@2x.png" alt="menu-add-palette" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/palettes/palette-add-color-light@2x.png" alt="palette-add-color" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/palettes/palette-add-color-dark@2x.png" alt="palette-add-color" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/palettes/palette-edit-name-light@2x.png" alt="palette-edit-name" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/palettes/palette-edit-name-dark@2x.png" alt="palette-edit-name" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/palettes/palette-group-colors-light@2x.png" alt="palette-group-colors" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/palettes/palette-group-colors-dark@2x.png" alt="palette-group-colors" />
...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/palettes/share-palette-light@2x.png" alt="share-palette" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/palettes/share-palette-dark@2x.png" alt="share-palette" />
