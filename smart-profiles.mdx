...
<img className="block h-auto w-full rounded-2xl dark:hidden" src="/_images/pages/smart-profiles/smart-profiles-light@2x.png" alt="smart-profiles" />
<img className="hidden h-auto w-full rounded-2xl dark:block" src="/_images/pages/smart-profiles/smart-profiles-dark@2x.png" alt="smart-profiles" />
