...
<img className="block dark:hidden rounded-lg" src="/_images/pages/smart-profiles/smart-profiles-light@2x.png" alt="smart-profiles" />
<img className="hidden dark:block rounded-lg" src="/_images/pages/smart-profiles/smart-profiles-dark@2x.png" alt="smart-profiles" />
