...
<img className="block h-auto w-full rounded-xl dark:hidden" src="/_images/pages/smart-formats/smart-formats-light@2x.png" alt="smart-formats" />
<img className="hidden h-auto w-full rounded-xl dark:block" src="/_images/pages/smart-formats/smart-formats-dark@2x.png" alt="smart-formats" />
