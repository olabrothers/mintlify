...
<img
	...
	src="/_images/pages/snapshots/snapshots-light@2x.png"
	alt="snapshots"
/>
<img
	className="hidden dark:block rounded-lg"
	src="/_images/pages/snapshots/snapshots-dark@2x.png"
	alt="snapshots"
/>
...
<Tip>
	<b>Example:</b> Use Reset Snapshots when you want to clear all previous
	backups and start a new history.
</Tip>
