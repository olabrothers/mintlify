...
<img className="block h-auto w-full rounded-xl dark:hidden" src="/_images/pages/editor/edit-color-value-light@2x.png" alt="edit-color-value" />
<img className="hidden h-auto w-full rounded-xl dark:block" src="/_images/pages/editor/edit-color-value-dark@2x.png" alt="edit-color-value" />
