...
<img className="block h-auto w-full rounded-lg dark:hidden" src="/_images/pages/color-formats/color-formats-light@2x.png" alt="color-formats" />
<img className="hidden h-auto w-full rounded-lg dark:block" src="/_images/pages/color-formats/color-formats-dark@2x.png" alt="color-formats" />
